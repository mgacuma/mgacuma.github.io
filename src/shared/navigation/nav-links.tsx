...
export const NavLinks: React.FC = () => {
    return (
        <Grid container direction={{xs: 'column',sm: 'row'}} height='64' columnSpacing={{xs: 0, sm: 2}} display={{xs: 'none', sm: 'flex'}} >
            <Grid item >
              <Link to="/" style={{textDecoration: 'none', color: '#27323d'}}><Typography variant="h4">Home</Typography></Link>
            </Grid>
            <Grid item>
              <Link to="/todo-app" style={{textDecoration: 'none', color: '#27323d'}}><Typography variant="h4">Todo App</Typography></Link>
            </Grid>
            <Grid item>
              <Link to="/quiz-app" style={{textDecoration: 'none', color: '#27323d'}}><Typography variant="h4">Quiz App</Typography></Link>
            </Grid>
            <Grid item >
